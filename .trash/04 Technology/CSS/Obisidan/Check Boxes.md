...
[[Search note]]
```
Source:: [CSS snippet for some pretty checkboxes. (from Border!) : r/ObsidianMD](https://www.reddit.com/r/ObsidianMD/comments/1hgszl7/css_snippet_for_some_pretty_checkboxes_from_border/)
Related To:: [[Tasks]]
***
# Body:
>[!abstract]- Examples
...
```
/* https://github.com/Akifyss/obsidian-border/blob/main/theme.css#L7875 */
...
input[data-task="“"]:checked,

li[data-task="“"]>input:checked,

li[data-task="“"]>p>input:checked,
