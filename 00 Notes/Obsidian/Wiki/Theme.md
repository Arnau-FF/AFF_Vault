...
Based on  [My material Gruvbox](https://github.com/AllJavi/material_gruvbox_obsidian)

Modified slightly and renamed to My GruvBox

## Backup

.obsidian\themes\My Gruvbox\theme.css![[Theme Backup.css]].obsidian\themes\My Gruvbox\manifest.json
...
  --custom-link-x: 92, 125, 201;

  --custom-link: rgb(var(--custom-link-x));

  --faded-custom-link-x: 92, 125, 1;

  --faded-custom-link: rgb(var(--custom-link-x));

  /* @settings

name:  My Gruvbox Color Overrides

id: gruvbox1-material-theme-override
...
  --cursor-line-background: rgba(var(--dark1-x), 0.0);
...
  --text-accent: var(--custom-link);

  --text-accent-hover: var(--faded-custom-link);
...
  --tag-background-hover: var(--dark2);
...
  border-left: 2px solid var(--background-secondary) !important;
